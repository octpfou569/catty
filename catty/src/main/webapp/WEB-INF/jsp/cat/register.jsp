									...
									<div class="row" >
										<div class="col-md-12 col-sm-12" >
											...
											<div class="col-sm-9" >
												<div class="col-md-12 col-sm-12" >
													<div class="col-sm-6">
														<div class="cat-input"><label for="name">이름: </label><input id="name" type="text" name="name" required /></div>
														<div class="cat-input"><label for="gender">성별: </label> 
															<select name="gender" required>
																<option value="M" selected>수컷</option>
																<option value="F">암컷</option>
															</select>
														</div>
														<div class="cat-input"><label for="spices">종: </label><input type="text" name="spices" /></div>
													</div>
													<div class="col-sm-6">
														<div class="cat-input"><label for="birthDate">출생 연월: </label><input type="date" name="birthDate" /></div>
														<div class="cat-input" ><label for="tnrStatus">중성화 여부: </label>
															<select name="tnrStatus" required>
																<option value="Y" selected>예</option>
																<option value="N">아니오</option>
															</select>
														</div>
														<div class="cat-input"><label for="tnrStatus">특징: </label> <input type="text" name="feature" /></div>
													</div>
												</div>
											</div>
										</div>
