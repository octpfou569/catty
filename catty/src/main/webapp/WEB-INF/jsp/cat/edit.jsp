									...
									<div class="row" >
										<div class="col-md-12 col-sm-12" >
											...
											<div class="col-sm-9" >
												<div class="row" >
													<div class="col-sm-6">
														<div class="cat-input">이름: <input type="text" name="name" value="${ cat.name }" required /></div>
														<div class="cat-input">성별: 
														...
														<div class="cat-input">종: <input type="text" name="spices" value="${ cat.spices }" /></div>
													</div>
													<div class="col-sm-6">
														<div class="cat-input">출생 연월: <input type="date" name="birthDate" value="${ cat.birthDate }" /></div>
														<div class="cat-input" >중성화 여부: 
														...
														<div class="cat-input">특징: <input type="text" name="feature" value="${ cat.feature }" /></div>
													</div>
												</div>
											</div>
										</div>
