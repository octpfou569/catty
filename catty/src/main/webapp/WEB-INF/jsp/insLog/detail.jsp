							...
							<div class="row">
								<div class="facility">
									<div class="facility-detail">
										<h3 class="facility-detail-title">점검일지 조회</h3>
										<div class="row">
											<div class="col-md-4">
												<div class="map" id="resource" style="margin-left:30px"></div>
											</div>
											<div class="col-md-8" >
												<div class="facility-info">
													<p id="facility-name" style="margin-top: 30px">이름 : ${facility.name}</p>
								...
								<div id="respond" class="comment-respond">
									<div class="row">
										<div class="col-md-12">
											<div class="ins-log-detail">
												<p>작성자 아이디 :	${member.id} (${member.name})</p>
									...
									<div class="row">
										<form action="/inslog" method="post" enctype="multipart/form-data" class="comment-form">
											...
											<img class="image-preview" id="image_preview" src="http://localhost/photo/inslog/${inspectionLog.no}" alt="점검일지 사진" onerror="this.src='https://via.placeholder.com/251x251'"/>
										</form>
									</div>
								</div>
							</div>
