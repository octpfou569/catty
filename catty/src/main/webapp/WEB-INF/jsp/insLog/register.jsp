							...
							<div class="row">
								<div class="facility">
									<div class="facility-detail">
										<h3 class="facility-detail-title">점검일지 등록</h3>
										<div class="col-md-10" >
										...
										<div class="col-md-2">
											<input type="button" class="button-move" id="button-moveFacilityDetail" onclick="moveFacilityDetail()" value="시설물 상세정보" style="margin-top: 345px;width:120px">
										</div>
									</div>
								</div>
							</div>
							<form action="/inslog" method="post" enctype="multipart/form-data" class="comment-form" id="registerForm">
								<div id="respond" class="comment-respond">
									<div class="row">
											...
											<textarea class="ins-log-note" id="note" name="note" placeholder="점검내용을 작성하세요" ></textarea>
											<div id="image"></div>
	        ...
	        success: function() {
				...
				if (facilityUid != null) {
		           ...
		           var position = new naver.maps.LatLng(facilityLatitude, facilityLongitude);
					...
					script += "<div class='ins-log-map-title'><h3>시설물을 선택해 주세요</h3></div>";
