							...
							<div class="row">
								<div class="facility">
									<div class="facility-detail">
										<h3 class="facility-detail-title">점검일지 수정</h3>
										<div class="col-md-4">
											<div class="map" id="resource"></div>
										</div>
										<div class="col-md-8" >
											<div class="facility-info">
												<p id="facility-name" style="margin-top: 50px">이름 : ${facility.name}</p>
								...
								<div id="respond" class="comment-respond">
									<div class="row">
										<div class="col-md-12">
											<div class="ins-log-detail">
												<p>작성자 ID :	${member.id} (${member.name})</p>
									...
									<div class="edit">
										<form action="${pageContext.request.contextPath}/inslog" method="post" enctype="multipart/form-data" class="comment-form" id="editSubmit">
											...
											<img class="image-preview" id="image" src="${pageContext.request.contextPath}/photo/inslog/${inspectionLog.no}" alt="점검일지 사진" onerror="this.src='https://via.placeholder.com/251x251'">
											<div class="row">
