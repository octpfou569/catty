...
<script>
	$(document).on("keyup", "input[name=phoneNo]", function() { $(this).val( $(this).val().replace(/[^0-9]/g, "").replace(/(^02|^0505|^1[0-9]{3}|^0[0-9]{2})([0-9]+)?([0-9]{4})$/,"$1-$2-$3").replace("--", "-") ); });
	...
	var nameJ = /^[가-힣]{2,6}$/;
	// 휴대폰 번호 정규식
	var phoneJ = /(^02|^0505|^1[0-9]{3}|^0[0-9]{2})(-)([0-9]+)?(-)([0-9]{4})$/;
